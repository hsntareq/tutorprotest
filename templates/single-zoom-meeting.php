                ...
                <?php
                    ...
                    <div class="zoom-meeting-countdown-wrap">
                        ...
                        <div class="tutor-zoom-join-button-wrap">
                            <a href="<?php echo $browser_url; ?>" target="_blank" class="tutor-btn d-block"><?php echo $browser_text; ?></a>
                            <a href="<?php echo $meeting_data['join_url']; ?>" target="_blank" class="tutor-btn tutor-is-outline d-block"><?php _e('Join in Zoom App', 'tutor-pro'); ?></a>
                        </div>
                    </div>
