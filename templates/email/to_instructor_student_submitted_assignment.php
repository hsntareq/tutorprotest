...
<div style="
	...
	<div style="background: url(<?php echo esc_url( tutor()->v2_img_dir ); ?>email-heading.svg) top right no-repeat;padding: 50px;">
		...
		<table style="margin: 20px 0;">
			<tr>
				<td><?php echo __( 'Student Name:', 'tutor-pro' ); ?></td>
				<td><strong>{student_name}</strong></td>
			</tr>
			<tr>
				<td><?php echo __( 'Course Name:', 'tutor-pro' ); ?></td>
				<td><strong>{course_name}</strong></td>
			</tr>
			<tr>
				<td><?php echo __( 'Assignment Name:', 'tutor-pro' ); ?></td>
		...
		<div data-source="email-before-button">{before_button}</div>
			...
			<a href="{course_url}" data-source="email-btn-url" style="
				...
				"><?php echo __( 'Mark as Approved', 'tutor-pro' ); ?></a>
		</div>
