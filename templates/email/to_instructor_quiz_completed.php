...
<div style="
	...
	<div style="background: url(<?php echo esc_url( tutor()->v2_img_dir ); ?>email-heading.svg) top right no-repeat;padding: 50px;">
		...
		<table>
			<tr>
				<td><?php echo __( 'Quiz Score:', 'tutor-pro' ); ?></td>
				<td><strong>80 out of 100</strong> <span style="color: #075A2A; border:1px solid #075A2A;border-radius: 42px;background: #E5F5EB;padding:3px 5px;">Pass</span></td>
			</tr>
		</table>
		...
		<div style="
			...
			<a href="{course_url}" data-source="email-btn-url" target="_blank" style="
					...
					align-items: center;
				"><?php echo __( 'Review Attempt', 'tutor-pro' ); ?></a>
		</div>
