	...
	if (is_array($answers) && count($answers)){
		...
		<div class="quiz-attempt-answers-wrap">
			...
			<div class="attempt-answers-header quiz-view-attempts-wrapper">
				<h3><?php _e('View Attempts', 'tutor-pro'); ?></h3>
				<a href="<?php echo remove_query_arg('view_quiz_attempt_id') ?>" class="tutor-btn back-to-quiz-btn"> <i class="tutor-icon-angle-left"></i>
