...
class Tutor_Notifications {
    ...
    public function load_scrips() {
        ...
        wp_enqueue_script( 'tutor-pn-registrar', TUTOR_NOTIFICATIONS()->url . 'assets/js/registrar.js', array( 'wp-i18n' ), TUTOR_NOTIFICATIONS_VERSION, true );
                    ...
                    'fields' => array(
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][course_enrolled]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][remove_from_course]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][assignment_graded]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][new_announcement_posted]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][after_question_answered]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_students][feedback_submitted_for_quiz]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'select_options' => false,
                            'options' => array(
                                '[tutor_pn_to_students][delete_from_course]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                    ...
                    'fields' => array(
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_instructors][instructor_application_accepted]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                        ...
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_instructors][instructor_application_rejected]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
                    ...
                    'fields' => array(
                        array(
                            ...
                            'options' => array(
                                ...
                                '[tutor_pn_to_admin][instructor_application_received]' => __( 'Push/Modals', 'tutor-pro' ),
                            ),
