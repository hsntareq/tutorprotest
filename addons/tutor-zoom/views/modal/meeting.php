                    ...
                    <div class="tutor-quiz-builder-row">
                        <div class="tutor-quiz-builder-col meeting-time-col">
                            <div class="date-range-input">
                                <input type="text" name="meeting_date" class="tutor_zoom_datepicker readonly" value="<?php echo $start_date; ?>" autocomplete="off" placeholder="<?php echo __( get_option( 'date_format'), 'tutor-pro' ); ?>" required>
                ...
                <div class="tutor-quiz-builder-col">
                    <?php 
                        ...
                        if($host_id) {
                            ...
                            ?>
                            <input type="hidden" name="meeting_host" value="<?php echo $host_id; ?>"/>
                            <input type="text" disabled="disabled" value="<?php echo $meeting_host_name; ?>" style="cursor:not-allowed"/>
                            <?php
                        }
                    ?>
                </div>
