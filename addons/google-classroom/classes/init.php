...
class init{
	...
	public function stream_tab_content($course_id=null){
		...
		strtolower($_SERVER['REQUEST_METHOD'])!='get' ? tutils()->checking_nonce() : 0;
	...
	public function tutor_gc_classes($attr=[]){
		...
		switch($column){
			...
			case 2 	: $column_class='col-xs-12 tutor-bs-col-sm-6'; break;
			case 3 	: $column_class='col-xs-12 tutor-bs-col-sm-6 tutor-bs-col-md-4'; break;
			case 4 	: $column_class='col-xs-12 tutor-bs-col-sm-6 tutor-bs-col-md-4 tutor-bs-col-lg-3'; break;
			case 6 	: $column_class='col-xs-12 tutor-bs-col-sm-6 tutor-bs-col-md-4 tutor-bs-col-lg-3 tutor-bs-col-xl-2'; break;
			default	: $column_class='col-xs-12 tutor-bs-col-sm-6 tutor-bs-col-md-4';
		}
