...
<div class="tutor-bs-container-fluid">
    <div class="tutor-bs-row tutor-gc-setting-container">
        <div class="tutor-bs-col-12 tutor-bs-col-xl-6">
            <div>
                <div class="tutor-bs-row align-items-center">
                    <div class="tutor-bs-col-12 tutor-bs-col-md-6">
                    ...
                    <div class="tutor-bs-col-12 tutor-bs-col-md-6" style="text-align:right">
                        <div class="tutor-gc-setting-content">
