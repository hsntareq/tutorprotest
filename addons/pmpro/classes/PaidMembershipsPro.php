...
class PaidMembershipsPro {
    ...
    public function __construct() {
        ...
        add_action('tutor_course/single/after/sidebar', array($this, 'pmpro_pricing') );
    ...
    private function required_levels($term_ids, $check_full = false) {
        ...
        return $wpdb->get_results(
            ...
            WHERE 
                ...
                (".($check_full ? " meta.meta_value='full_website_membership' " : '')." {$cat_clause}) ");
    }
    ...
    private function has_course_access($course_id, $user_id=null){
        ...
        foreach( $levels as $level ) {
            ...
            // Remove enrollment of expired levels
    ...
    public function pmpro_pricing() {
        
        $required_levels = $this->has_course_access(get_the_ID());
        if($required_levels===true){
