        ...
        <table class="tutor-list-table">
            <thead>
                <tr>
                    ...
                    <th><?php _e('Enroll Date & Time', 'tutor-pro'); ?></th>
                ...
                if ($enrolled_course && is_array($enrolled_course->posts) && count($enrolled_course->posts)){
                    foreach ($enrolled_course->posts as $course){ $counter++;
                        ...
                        <tr>
                            ...
                            <td><?php echo date('F j Y g:i a', strtotime($course->post_date)); ?></td>
                            <td>
                                <span class="complete">
                                    <?php 
                            ...
                            <td>
                                <span class="complete">
                                    <?php echo count(tutor_utils()->get_course_content_ids_by('tutor_assignments', tutor()->course_post_type, $course->ID)); ?>
                                </span>
                            </td>
                        ...
                        <!-- complete running incomplete -->
                            <td colspan="100%">
                                <div class="course-list-details">
                                    <?php if(count( $total_lesson ) > 0) { ?>
                                        <div class="detail">
                                            <div class="heading"><?php _e('Lesson', 'tutor-pro'); ?></div>
                                            <div class="status">
                                                <?php 
                                                $count = count($total_lesson) - 1;
                                                $posts_data = $total_lesson;
                                    ...
                                    <?php } ?>
                                    <?php if(count($assignment_ids) > 0) { ?>
                                        <div class="detail">
                                            <div class="heading"><?php _e('Assignment', 'tutor-pro'); ?></div>
                                            <div class="status">
                                                <?php foreach ($assignment_ids as $id) { ?>
                                                    <span class="complete"><?php echo get_the_title($id); ?></span><br>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    <?php } ?>
