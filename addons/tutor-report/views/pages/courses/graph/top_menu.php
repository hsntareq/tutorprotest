    ...
    <div class="tutor-date-range-wrap">
        <form action="" class="report-date-range-form" method="get">
            ...
            <div class="date-range-input">
                <input type="text" name="date_range_from" class="tutor_date_picker tutor_report_datepicker" value="<?php echo '' !== $date_range_from ? tutor_get_formated_date( get_option( 'date_format' ), $date_range_from ) : ''; ?>" autocomplete="off" placeholder="<?php _e( get_option( 'date_format' ), 'tutor-pro' ); ?>" />
                <i class="tutor-icon-calendar"></i>
            </div>

            <div class="date-range-input">
                <input type="text" name="date_range_to" class="tutor_date_picker tutor_report_datepicker" value="<?php echo '' !== $date_range_to ? tutor_get_formated_date( get_option( 'date_format' ), $date_range_to ) : ''; ?>" autocomplete="off" placeholder="<?php _e( get_option( 'date_format' ), 'tutor-pro' ); ?>" />
                <i class="tutor-icon-calendar"></i>
            </div>
