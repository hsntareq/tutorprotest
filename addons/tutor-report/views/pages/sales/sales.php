						...
						<td>
							<?php 
								$available_status = array(
									...
									'processing'=> __( 'processing', 'tutor-pro' ),
								);
								$sales_status = isset( $available_status[$report->post_status] ) ? $available_status[$report->post_status] : $report->post_status;
								echo $order ? $sales_status : '-'; 
							?>
						</td>
					</tr>
			<?php } ?>
