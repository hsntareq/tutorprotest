...
/*!****************************************************!*\
  !*** ./addons/tutor-report/assets/react/report.js ***!
  \****************************************************/
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.tutor-rating-delete-link', function (e) {
    ...
    $.ajax({
      ...
      type: 'POST',
      data: {
        review_id: $that.attr('data-rating-id'),
        action: 'tutor_review_delete'
      },
  ...
  $(document).on('click', '.tutor-quiz-attempt-delete-btn', function (e) {
    ...
    $.ajax({
      ...
      data: {
        ...
        action: 'treport_quiz_atttempt_delete'
      },
      beforeSend: function beforeSend() {
        $that.addClass('updating-message');
      },
  ...
  $(document).on('click', '.details-link', function (e) {
    ...
    var infoRow = $('#table-toggle-' + $(this).data('count'));
